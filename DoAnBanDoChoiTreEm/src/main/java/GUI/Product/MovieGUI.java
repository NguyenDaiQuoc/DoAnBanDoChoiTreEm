...
public class MovieGUI extends JPanel {
    ...
    private JTextField idField, tenField, giaField, xuatXuField, soLuongField, soLuongConLaiField, tenPhimField, searchField;
    ...
    public MovieGUI() {
        ...
        JLabel titleLabel = new JLabel("ĐỒ CHƠI THEO PHIM");
        ...
        tenPhimField = new JTextField(20);
...
//         Thêm sự kiện cho nút thêm
        addButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(idField.getText().isEmpty() || tenField.getText().isEmpty() || giaField.getText().isEmpty() || xuatXuField.getText().isEmpty() || soLuongField.getText().isEmpty() || soLuongConLaiField.getText().isEmpty() || tenPhimField.getText().isEmpty()){
                    JOptionPane.showMessageDialog(null, "Vui lòng điền đầy đủ thông tin!");
                    return;
                }
                //Kiem tra id
                if (!idField.getText().startsWith("11")) {
                    JOptionPane.showMessageDialog(null, "ID phải bắt đầu bằng 11!");
                    return;
                }
                ...
                ArrayList<DoChoiTheoPhim> products = bus.getAllMovieToys();
                for(DoChoiTheoPhim product : products){
                ...
                DoChoiTheoPhim newProduct = new DoChoiTheoPhim();
                ...
                newProduct.setTenPhim(tenPhimField.getText());
                bus.addMovieToy(newProduct);
                loadAllMovieToys();
        ...
        editButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e){
                ...
                tenPhimField.setText(productTable.getValueAt(selectedRow, 6).toString());
                }
                else{
        ...
        searchButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                ArrayList<DoChoiTheoPhim> products = bus.searchMovieToysById(id);
                for(DoChoiTheoPhim product : products){
                    String[] rowData = {product.getId(), product.getTen(), String.valueOf(product.getGia()), product.getXuatxu(), String.valueOf(product.getSoLuong()), String.valueOf(product.getSoLuongConLai()), product.getTenPhim()};
