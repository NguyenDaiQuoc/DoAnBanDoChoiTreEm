...
public class tables {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            st.executeUpdate("insert into dochoiphuongtien (id, ten, gia, xuatxu, soluong, soLuongConLai, loaiPhuongTien) values('1001', 'Đồ chơi xe công trình 3L 3LHGL888', 69.000, 'Vietnam', 10, 10, 'xe công trình')");
            st.executeUpdate("insert into dochoiphuongtien (id, ten, gia, xuatxu, soluong, soLuongConLai, loaiPhuongTien) values('1002', 'Đồ chơi xe công trình điều khiển 3L 3L3688-K72', 82.500, 'Vietnam', 10, 10,  'xe công trình')");
            st.executeUpdate("insert into dochoiphuongtien (id, ten, gia, xuatxu, soluong, soLuongConLai, loaiPhuongTien) values('1003', 'Đồ chơi xe công trình LATOYS LA10368-8', 18.000, 'Vietnam', 10, 10,  'xe công trình')");
            st.executeUpdate("insert into dochoiphuongtien (id, ten, gia, xuatxu, soluong, soLuongConLai, loaiPhuongTien) values('1004', 'Đồ chơi lắp ráp xe công trình 3L 3LHL8610', 39.500, 'Vietnam', 10, 10,  'xe lắp ráp')");
            st.executeUpdate("insert into dochoiphuongtien (id, ten, gia, xuatxu, soluong, soLuongConLai, loaiPhuongTien) values('1005', 'Đồ chơi xe điều khiển 3L 3L6918-100', 119.500, 'Vietnam', 10, 10,  'xe điều khiển')");
            st.executeUpdate("insert into dochoiphuongtien (id, ten, gia, xuatxu, soluong, soLuongConLai, loaiPhuongTien) values('1006', 'Đồ chơi xe tăng 3L 3LHY-169', 39.000, 'Vietnam', 10, 10,  'xe tăng')");
            st.executeUpdate("insert into dochoiphuongtien (id, ten, gia, xuatxu, soluong, soLuongConLai, loaiPhuongTien) values('1007', 'Đồ chơi xe công trình 3L 3LLY037F', 39.000, 'Vietnam', 10, 10,  'xe công trình')");
            st.executeUpdate("insert into dochoiphuongtien (id, ten, gia, xuatxu, soluong, soLuongConLai, loaiPhuongTien) values('1008', 'Đồ chơi xe hợp kim 3L 3L388-54C', 442.000, 'Vietnam', 10, 10,  'xe hợp kim')");
            st.executeUpdate("insert into dochoiphuongtien (id, ten, gia, xuatxu, soluong, soLuongConLai, loaiPhuongTien) values('1009', 'Đồ chơi xe bus 3L 3LBH668-3', 39.000, 'Vietnam', 10, 10,  'xe bus')");
            st.executeUpdate("insert into dochoiphuongtien (id, ten, gia, xuatxu, soluong, soLuongConLai, loaiPhuongTien) values('1010', 'Đồ chơi xe công trình 3L 3L706-33', 39.000, 'Vietnam', 10, 10,  'xe công trình')");
